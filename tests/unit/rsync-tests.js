...
describe('Rsync', function () {
  ...
  it('should succeed with Uint8Array data', function (done) {
    OPTION_REC_SIZE.time = true;
    fs.mkdir('/projects', function (err) {
      expect(err).to.not.exist;
      fs2.mkdir('/projects', function (err) {
        expect(err).to.not.exist;
        var arrayData = new Uint8Array([102, 117, 110, 99, 116, 32, 104, 101, 108, 108, 111, 40, 41, 32, 123, 32, 119, 105, 110, 100, 111, 119, 46, 114, 117, 110, 110, 101, 114, 87, 105, 110, 100, 111, 119, 46, 112, 114, 111, 120, 121, 67, 111, 110, 115, 111, 108, 101, 46, 108, 111, 103, 40, 34, 104, 101, 108, 108, 111, 34, 41, 59, 32, 125, 32, 104, 101, 108, 108, 111, 40, 41, 59]);
              ...
              rsync.diff(fs, '/projects/hello', data, OPTION_REC_SIZE, function (err, data) {
                ...
                rsync.patch(fs2, '/projects/hello', data, OPTION_REC_SIZE, function (err) {
                  ...
                  fs2.readFile('/projects/hello', function (err, data) {
                    ...
                    var arrayData2 = new Uint8Array([40, 41, 32, 123, 32, 119, 105, 110, 100, 111, 119, 46, 114, 117, 110, 110, 101, 114, 87, 105, 110, 100, 111, 119, 46, 112, 114, 111, 120, 121, 67, 111, 110, 115, 111, 108, 101, 46, 108, 111, 103, 40, 34, 104, 101, 108, 108, 111, 34, 41, 59, 32, 125, 32, 102, 117, 110, 99, 105, 111, 110, 32, 119, 111, 114, 108, 100, 40]);
