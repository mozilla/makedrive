...
SyncMessage.prototype.is = Object.create(Object.prototype, {
  // Types
  request: {
    get: function() { return this.type === SyncMessage.REQUEST; }
  },
  response: {
    get: function() { return this.type === SyncMessage.RESPONSE; }
  },
  error: {
    get: function() { return this.type === SyncMessage.ERROR; }
  },

  // Names
  srclist: {
    get: function() { return this.name === SyncMessage.SRCLIST; }
  },
  sync: {
    get: function() { return this.name === SyncMessage.SYNC; }
  },
  chksum: {
    get: function() { return this.name === SyncMessage.CHKSUM; }
  },
  diffs: {
    get: function() { return this.name === SyncMessage.DIFFS; }
  },
  patch: {
    get: function() { return this.name === SyncMessage.PATCH; }
  },
  reset: {
    get: function() { return this.name === SyncMessage.RESET; }
  },
  locked: {
    get: function() { return this.name === SyncMessage.LOCKED; }
  },
  authz: {
    get: function() { return this.name === SyncMessage.AUTHZ; }
  },
  impl: {
    get: function() { return this.name === SyncMessage.IMPL; }
  }
});
